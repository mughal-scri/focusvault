...
import { useTheme, ACCENT_OPTIONS } from '../theme/ThemeContext';
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={[styles.card, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          ...
          <Text style={[styles.accentLabel, { color: colors.textMuted }]}>
            {ACCENT_OPTIONS.find(c => c.value === accentColor)?.label}
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  card: { borderRadius: 16, padding: 16, marginHorizontal: 20, borderWidth: 1 },
  cardTitle: { fontSize: 15, fontWeight: '600', marginBottom: 12 },
  themeRow: { flexDirection: 'row', gap: 8 },
  themeBtn: {
    flex: 1, flexDirection: 'row', alignItems: 'center',
    justifyContent: 'center', gap: 6, padding: 10,
    borderRadius: 10, borderWidth: 1, minHeight: 48,
  },
  ...
  statsCard: {
    ...
    marginHorizontal: 20, borderWidth: 1, justifyContent: 'space-between',
  },
  ...
  actionRow: {
    ...
    paddingVertical: 14, borderBottomWidth: 1, minHeight: 52,
  },
  ...
  rowItem: {
    ...
    paddingVertical: 12, borderBottomWidth: 1, minHeight: 48, alignItems: 'center',
  },
  ...
  footer: {
    ...
    fontStyle: 'italic', marginTop: 24, marginBottom: 8,
  },
});